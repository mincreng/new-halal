...
<div class="page-right-sidebar payment-option-page">
  ...
  <?php echo CHtml::textField('time_of_deposit','',array('class'=>"timepick",'data-validation'=>"required"))?>
  </div>
  
  <div class="uk-form-row">
  <label class="uk-form-label"><?php echo Yii::t("default","Amount")?></label>
  <?php echo CHtml::textField('amount','',array('data-validation'=>"required",'class'=>'numeric_only'))?>
  </div>
