	   ...
	   <div class="box-grey rounded">      
         ...
         <?php echo CHtml::hiddenField('currentController','store')?>        
          ...
          <?php if ($google_login_enabled==2 || $fb_flag==2 ) :?>
              <?php if ( $fb_flag==2):?>
	          <a href="javascript:;" class="fb-button orange-button medium rounded">
		...
		<?php if ($google_login_enabled==2 || $fb_flag==2 ) :?>
		<div id="section-social-login" class="top30 row ">
		   <div class="col-md-6 border a">&nbsp;</div>
		   <div class="col-md-6 border">

		     <div class="row pull-right border">
		       <div class="col-md-5 col-sm-5 text-right into-row"><?php echo t("Login by")?></div>
		       <div class="col-md-2  text-center into-row" >
		         <?php if ($google_login_enabled==2):?>
		         <a href="<?php echo Yii::app()->createUrl('/store/googleLogin')?>" class="rounded-circle" >
		            <i class="i-big ion-social-googleplus-outline"></i>
		         </a>
		         <?php endif;?>
		       </div>
		       <?php if ( $fb_flag==2):?>
			       <?php if ($google_login_enabled==2):?>
			       <div class="col-md-2 text-center into-row"><?php echo t("Or")?></div>
			       <?php endif;?>
		       <div class="col-md-2 into-row" >
		         <a href="javascript:fbcheckLogin();" class="rounded-circle">
		           <i class="i-big ion-social-facebook"></i>
		         </a>
		       </div>
		       <?php endif;?>
		...
		<?php if ($google_login_enabled==2 || $fb_flag==2 ) :?>
		<div id="mobile-social-login" class="top30 row ">
		   <div class="col-sm-2 col-xs-2 border a"><?php echo t("Login by")?></div>
		   <div class="col-sm-2 col-xs-2 border">
		        <?php if ($google_login_enabled==2):?>
		         <a href="<?php echo Yii::app()->createUrl('/store/googleLogin')?>" class="rounded-circle" >
		            <i class="i-big ion-social-googleplus-outline"></i>
		         </a>
		   ...
		   <div class="col-sm-2 col-xs-2 border">
		     <?php if ($google_login_enabled==2):?>
		        <a href="javascript:checkLoginState();" class="rounded-circle">
		           <i class="i-big ion-social-facebook"></i>
		         </a>
		     <?php endif;?>
		   </div>
		</div> <!--mobile-social-login-->
		<?php endif;?>
