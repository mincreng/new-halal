<?php
$paymode=Yii::app()->functions->getOptionAdmin('merchant_rzr_mode');
?>
...
<div class="uk-form-row">
  ...
  getOptionA('merchant_rzr_enabled')==2?true:false
  ,array(
    'value'=>2,
    'class'=>"icheck"
  ))
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('merchant_razor_key_id_sanbox')
  ,array(
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('merchant_razor_secret_key_sanbox')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('merchant_razor_key_id_live')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('merchant_razor_secret_key_live')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
