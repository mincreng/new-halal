<?php
$paymode=Yii::app()->functions->getOptionAdmin('merchant_btr_mode');
?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_sanbox_brain_mtid')
  ,array(
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_sanbox_brain_publickey')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_sanbox_brain_privateckey')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_live_brain_mtid')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_live_brain_publickey')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
...
<div class="uk-form-row">
  ...
  Yii::app()->functions->getOptionAdmin('mt_live_brain_privateckey')
  ,array(
    'class'=>"uk-form-width-large"
  ))
  ?>
