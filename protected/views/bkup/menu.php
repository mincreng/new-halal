...
<div class="menu-wrapper page-right-sidebar <?php echo $style_bg;?>">
  <div class="main">    
  <div class="inner">
  ...
  <div class="restaurant-wrap">
    <div class="uk-grid">
      ...
      <div class="uk-width-1-3">
        ...
        <?php echo FormatDateTime(date('c'));?>
        </p>                
        <?php endif;?>
  ...
  <ul class="uk-switcher uk-margin" id="tab-content">
    ...
    <li>
       <!--START REVIEWS-->
	   <!--<div class="list-reviews rounded2">
	     <div class="head"> 
	        <div class="avatar left"><i class="fa fa-user"></i></div> 
	        <h4 class="left uk-text-bold">Nick b</h4>
	        <div class="clear"></div>
	     </div>
	     <div class="body">
	       <p class="uk-text-muted uk-text-small">5 days ago</p>
	       <p><span class="uk-text-bold">Rated</span> <span class="uk-badge uk-badge-success">5.0</span>
	       Foods are delicious. Services are great. Nice place. Worth the price :) </p>
	       
	       <div class="review-action right">
	       <a href="javascript:;" class="edit-review uk-button">Edit</a>
	       <a href="javascript:;" class="delete-review uk-button">Delete</a>
	       </div>
	       <div class="clear"></div>
