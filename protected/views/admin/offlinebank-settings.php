...
<div class="uk-form-row">
  ...
  <?php   
  echo CHtml::textField('admin_deposit_sender',Yii::app()->functions->getOptionAdmin('admin_deposit_sender'),array(
...
<div class="uk-form-row">
  ...
  <?php   
  echo CHtml::textField('admin_deposit_subject',Yii::app()->functions->getOptionAdmin('admin_deposit_subject'),array(
...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::textArea('admin_deposit_instructions',$deposit_instructions,array(
    'class'=>'big-textarea'
  ));
  ?>
</div>
